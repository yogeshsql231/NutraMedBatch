...
class PackagingOrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate(
            [
                ...
                'Exp' => [
                    'nullable',
                    'string',
                    'regex:/^(\d{4}\/(0[1-9]|1[0-2]))$|^(0[1-9]|[12][0-9]|3[01])\/(0[1-9]|1[0-2])\/\d{4}$|^(0[1-9]|[12][0-9]|3[01])\/\d{4}$|^(0[1-9]|1[0-2])\/\d{4}$/'
                ],
            ...
            [
                ...
                'Exp.regex' => 'The Exp field must be in one of the following formats: YYYY/MM, MM/YYYY, DD/MM/YYYY, or YYYY/DD.',
            ]
        );
        ...
        try {
            ...
            $packagingOrder->testSerial = json_encode($validated['test']);
