...
<div class="row mb-5">
    <div class="col col-4">
        <form id="orderForm" action="{{route('EditDuplicatePackagingOrder')}}" method="get">
...
<form action="{{ route('updateDuplicatePackagingOrder',['DuplicatePackagingOrder'=>$editData->id]) }}" method="POST">
    @csrf
    <div class="row">
        <div class="col col-6">
