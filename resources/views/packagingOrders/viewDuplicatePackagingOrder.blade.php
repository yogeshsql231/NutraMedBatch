                ...
                <div class="table-responsive">
                    <table class="table table-striped" id="table-2">
                        ...
                        <tbody>
                            ...
                            @foreach ($duplicateOrderRecords as $item)
                            <tr>
                                <td>
                                    <div class="custom-checkbox custom-control">
                                ...
                                <td>
                                    @php
                                    $DecodedTest=json_decode($item->testSerial)
                                    @endphp

                                    @if(is_array($DecodedTest))
                                    @foreach ($DecodedTest as $index => $serial)
                                    {{$index+1}}. {{$serial}} @if(!$loop->last)
                                    ,
                                    @endif
                                    @endforeach
                                    @else
