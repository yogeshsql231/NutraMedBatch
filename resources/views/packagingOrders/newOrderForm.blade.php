...
<form action="{{ route('packagingOrderSubmit') }}" method="POST">
    ...
    <div class="container">
            ...
            <div class="col-6">
                <div class="row">
                    ...
                    <div class="col-12 col-md-12 d-flex align-items-center mt-1">
                        ...
                        <input type="number" name="matWidth" id="matWidth" class="form-control"
                            value="{{ old('matWidth') }}">
                        @error('matWidth')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="col-12 col-md-12 d-flex align-items-center mt-1">
                        <div class="row">
                            <div class="col-12 col-md-8 d-flex align-items-center">
                                ...
                                <input type="number" name="foilYield" id="foilYield" class="form-control"
                                    value="{{ old('foilYield') }}">
                                @error('foilYield')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                    ...
                    <div class="col-12 d-flex align-items-center mt-1">
                        <div class="row">
                            <div class="col-12 col-md-8 d-flex align-items-center">
                                ...
                                <input type="number" name="PvcYield" id="PvcYield" class="form-control"
                                    value="{{ old('PvcYield') }}">
                                @error('PvcYield')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
        ...
        {{-- add the dynamic text box --}}
        <div class="row mt-2" id="dynamicInputContainer">
            <div class="col-12 col-md-4 mb-2 d-flex align-items-center">
                <label for="test" class="form-label me-1">Test</label>
                <input type="text" name="test[]" class="form-control me-2" value="{{ old('test[0]') }}">
                <button type="button" class="btn  btn-sm btn-primary ml-2 mr-2" id="addInput">Add More</button>
                <button type="button" class="btn  btn-sm btn-danger" id="removeInput">Delete</button>
            </div>
        </div>
        ...
        {{-- Add the dynamic Field IndexSetting --}}
        <div class="row mt-2" id="dynamicFieldsIndexSetting">
            <div class="col-12 col-md-4 mb-2 d-flex align-items-center">
                <label for="IndexSetting" class="form-label me-1">Index Setting</label>
                <input type="text" name="indexSetting[]" class="form-control me-2" value="{{ old('indexSetting[0]') }}">
                <button type="button" class="btn btn-sm btn-primary ml-2 mr-2" id="addInputIndexSetting">Add
                    More</button>
                <button type="button" class="btn btn-sm btn-danger" id="removeInputIndexSetting">Delete</button>
            </div>
        </div>
...
{{-- Js for dynamic IndexSetting box --}}
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const addInputIndexSetting = document.getElementById('addInputIndexSetting');
        const containerIndexSetting = document.getElementById('dynamicFieldsIndexSetting');

        // Add more IndexSetting input fields
        addInputIndexSetting.addEventListener('click', function () {
            const newInputGroup = document.createElement('div');
            newInputGroup.classList.add('col-12', 'col-md-4', 'mb-2', 'd-flex', 'align-items-center');

            newInputGroup.innerHTML = `
                <label class="form-label me-1">Index Setting</label>
                <input type="text" name="indexSetting[]" class="form-control me-2">
                <button type="button" class="btn btn-sm btn-danger removeInputIndexSetting">Delete</button>
            `;

            containerIndexSetting.appendChild(newInputGroup);
        });

        // Event delegation for dynamically added remove buttons for IndexSetting
        containerIndexSetting.addEventListener('click', function (e) {
            if (e.target && e.target.classList.contains('removeInputIndexSetting')) {
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        addInput.addEventListener('click', function () {
            ...
            newInputGroup.innerHTML = `
                <label class="form-label me-1">Test</label>
                <input type="text" name="test[]" class="form-control me-2">
                <button type="button" class="btn btn-sm btn-danger removeInput">Delete</button>
            `;
